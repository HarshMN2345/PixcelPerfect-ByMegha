...
const FrameComponent1: NextPage<FrameComponent1Type> = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-col items-start justify-start gap-[48px] max-w-full text-left text-base-7 text-gray-600 font-title-medium px-5 mq800:px-4 ${className}`}
    >
      <div className="self-stretch flex flex-col items-start justify-start pt-0 pb-2 box-border gap-[48px] max-w-full mq800:gap-[24px]">
        <div className="self-stretch flex flex-row items-start justify-center max-w-full">
          <div className="flex flex-row flex-wrap items-start justify-center gap-[16.1px] max-w-full">
      ...
      <div className="self-stretch flex flex-row items-start justify-center">
        <button className="cursor-pointer py-2.5 px-[31px] bg-gray-600 rounded-81xl flex flex-row items-start justify-start whitespace-nowrap border-[1px] border-solid border-goldenrod-200 hover:bg-blue-950 hover:box-border hover:border-[1px] hover:border-solid hover:border-goldenrod-300">
          <a
